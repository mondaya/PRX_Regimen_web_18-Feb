<div class="main order-main">
    <div class="container">
        <div class="order-list">
            <h2 class="title-border">My Custom Orders</h2>
                    ...
                    <div class="form-inline full-width-text">
                        ...
                        <div class="form-group">
                            <select class="gender order-form" name="status" id="status" onchange="this.form.submit()">
                                ...
                                <option value="a" %SELECTED_A%>Accepted</option>
                                <option value="r" %SELECTED_R%>Rejected</option>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $(document).on("click",".buttonPage",function(){
          ...
          $.ajax({
                type: 'POST',
                url: '<?php echo SITE_MOD; ?>myCustomOrder-nct/ajax.myCustomOrder.php',
