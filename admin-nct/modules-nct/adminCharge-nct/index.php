<?php
	...
	include("class.adminCharge-nct.php");
	$module = "adminCharge-nct";
	$table = "tbl_admin_charge";
	...
	$headTitle = $type == 'add' ? 'Add' : ($type == 'edit' ? 'Edit' : 'Manage').' Admin Charge';
		...
		if($objPost->countryId != ""){
			if($type == 'edit' && $id > 0){
				...
				if(in_array('add',$Permission)){
						...
						$exist = getTableValue('tbl_admin_charge','id',array('countryId'=>$objPost->countryId));
	...
	$objSubcategory = new adminCharge($module, $id, NULL, $searchArray, $type);
