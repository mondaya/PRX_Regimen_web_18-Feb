	...
	$(document).on('submit','#frmCont', function(e){
		...
		$("#frmCont").validate({
			...
			errorElement: 'span',
			rules:{
				pageName:{required: true,pagenm: true
				/*remote:{
						url:"<?php echo SITE_ADM_MOD.$this->module ?>/ajax.<?php echo $this->module;?>.php",
						type: "post",
						async:false,
						data: {ajaxvalidate:true,page_name: function() {return $("#pageName").val();},id: function() {return $("#id").val();}},
			...
			messages:{
				...
				metaKeyword:{required:'&nbsp;Please enter meta keyword'},
				metaDesc:{required:'&nbsp;Please enter meta description'},
