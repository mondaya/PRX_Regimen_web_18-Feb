...
$(function() {
	OTable= $('#example123').dataTable( {
		...
		fnServerData: function (sSource, aoData, fnCallback) {
		 ...
		 aoColumns: [
			{ sName: "currency", sTitle : 'Currency'},
			{ sName: "currencyValue", sTitle : 'Currency Value'}
	...
	$(document).on('submit','#frmCont', function(e){
		...
		$("#frmCont").validate({
			...
			errorElement: 'span',
			rules:{
				currencyValue: {required: true,number: true},
				currency: {required: true}                    
			},
			messages:{
				currencyValue: {required: "&nbsp;Please enter currency value"},
