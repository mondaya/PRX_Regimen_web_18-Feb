<form action="" method="post" name="frmCont" id="frmCont" class="form-horizontal" enctype="multipart/form-data" novalidate="novalidate">
	<div class="form-body">
		...
		<div class="form-group">
	 		<label for="countryName" class="control-label col-md-3">%MEND_SIGN%Duties Amount(%) : &nbsp;</label>
	 		<div class="col-md-4">
	 			<input type="number" min="1" class="form-control logintextbox-bg required" name="amount" id="amount" value="%DUTIES_AMOUNT%">
	 		</div>
	 	</div>

	 	<div class="form-group">
	 		<label for="countryName" class="control-label col-md-3">%MEND_SIGN%Minimum Duties Amount(%SITE_CURR%) : &nbsp;</label>
	 		<div class="col-md-4">
