	...
	OTable= $('#example123').dataTable( {
		...
		fnServerData: function (sSource, aoData, fnCallback) {
		 ...
		 aoColumns: [
			...
			{ sName: "amount", sTitle : 'Duties Amount(%)'},
			{ sName: "minimumAmount", sTitle : 'Minimum Duties Amount'}
	...
	$(document).on('submit','#frmCont', function(e){
		...
		$("#frmCont").validate({
			...
			messages:{
				...
				amount: { required: "&nbsp;Please enter duties amount"},
				minimumAmount: { required: "&nbsp;Please enter minimum duties amount"}
			},
