	...
	OTable= $('#example123').dataTable( {
		...
		fnServerData: function (sSource, aoData, fnCallback) {
		 ...
		 aoColumns: [
			...
			{ sName: "amount", sTitle : 'Shipping Amount(%)'},
			{ sName: "minimumAmount", sTitle : 'Minimum Shipping Amount'},
			{ sName: "deliveryDays", sTitle : 'Delivery Days'}
	...
	$(document).on('submit','#frmCont', function(e){
		...
		$("#frmCont").validate({
			...
			rules:{
				...
				deliveryDays: {required: true}
			},
			messages:{
				country: {required: "&nbsp;Please select country"},
				state: { required: "&nbsp;Please select state"},
				amount: { required: "&nbsp;Please enter shipping amount"},
				minimumAmount: { required: "&nbsp;Please enter minimum shipping amount"},
				deliveryDays: { required: "&nbsp;Please enter delivery days"}
			},
