<form action="" method="post" name="frmCont" id="frmCont" class="form-horizontal" enctype="multipart/form-data" novalidate="novalidate">
 <div class="form-body">
 	...
 	<div class="form-group"> 
 		<label for="creditAmount" class="control-label col-md-3">Credit Amount(%SITE_CURR%): &nbsp;</label> 
 		<div class="col-md-4"> <input type="number" min="0" class="form-control logintextbox-bg" name="creditAmount" id="creditAmount" value="%CREDIT_AMOUNT%" disabled> </div>
 	</div>
 	<div class="form-group"> 
 		<label for="creditAmount" class="control-label col-md-3">Add Amount(%SITE_CURR%): &nbsp;</label> 
 		<div class="col-md-4"> <input type="number" min="1" class="form-control logintextbox-bg" name="addAmount" id="addAmount"> </div>
 	</div>
 	<div class="form-group"> 
 		<label for="creditAmount" class="control-label col-md-3">Remove Amount(%SITE_CURR%): &nbsp;</label> 
 		<div class="col-md-4"> <input type="number" min="1" class="form-control logintextbox-bg" name="removeAmount" id="removeAmount" %DISABLED_REMOVEAMOUNT%> </div>
 	</div>
 	<div class="form-group">
