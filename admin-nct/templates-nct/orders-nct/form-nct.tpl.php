		...
		<div class="form-group">
			...
			<div class="col-md-4">
				<div class="radio-list" data-error-container="#form_2_Status: _error">
					<label class="">
						<input class="radioBtn-bg required" id="n" name="deliveryStatus" type="radio" value="s" %DELIVERY_S%>Shipped</label>
					<span for="isActive" class="help-block"></span>
					<label class="">
						<input class="radioBtn-bg required" id="n" name="deliveryStatus" type="radio" value="d" %DELIVERY_D%>Delivered</label>
					<span for="isActive" class="help-block"></span>
					<label class="">
						<input class="radioBtn-bg required" id="a" name="deliveryStatus" type="radio" value="p" %DELIVERY_P%>Pending</label>
					<span for="isActive" class="help-block"></span>
