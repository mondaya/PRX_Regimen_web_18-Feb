<?php
if($_SERVER["SERVER_NAME"]=="nct93" || $_SERVER["SERVER_NAME"]=="nct24" || $_SERVER["SERVER_NAME"]=="localhost")
{

	define("THMB_SITE_UPD",'http://'.$_SERVER["SERVER_NAME"].'/wellness/upload-nct/');
}
else
{
	define("THMB_SITE_UPD",'http://'.$_SERVER["SERVER_NAME"].'/upload-nct/');
}
...
class timthumb {
	...
	public function __construct(){
		...
		$this->flg = $this->param('flg');
		if($this->flg == "")
		{
			$this->src = THMB_SITE_UPD.$this->param('src');
		}
		else
		{
