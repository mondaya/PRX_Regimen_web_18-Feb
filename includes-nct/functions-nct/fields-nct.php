...
class fields{
	...
	public function textBox($text){
		...
		$text['placeholder'] = isset($text['placeholder']) ? $text['placeholder'] : '';

		if($text["onlyField"]==true){
			$main_content = new Templater(DIR_FIELDS_HTML.'textbox_onlyfield.tpl.php');
        }
        else{
			$main_content = new Templater(DIR_FIELDS_HTML.'textbox.tpl.php');
       }
		$main_content=$main_content->parse();
		$fields = array("%CLASS%","%NAME%","%ID%","%VALUE%","%EXTRA%","%LABEL%","%PLACEHOLDER%");
		$fields_replace = array($text['class'],$text['name'],$text['name'],$text['value'],$text['extraAtt'],$text['label'],$text['placeholder']);
	...
	public function hidden($text) {
		...
		$main_content = new Templater(DIR_FIELDS_HTML.'hidden.tpl.php');
		$main_content=$main_content->parse();
	...
	public function fileBox($text){
		...
		if($text["onlyField"]==true){
			$main_content = new Templater(DIR_FIELDS_HTML.'filebox_onlyfield.tpl.php');
        }
        else{
			$main_content = new Templater(DIR_FIELDS_HTML.'filebox.tpl.php');
       }
	   	$main_content=$main_content->parse();
	...
	public function displayBox($text){
		...
		$main_content = new Templater(DIR_FIELDS_HTML.'displaybox.tpl.php');
		$main_content=$main_content->parse();
	...
	public function password($text){
		...
		if($text["onlyField"]==true){
			$main_content = new Templater(DIR_FIELDS_HTML.'password_onlyfield.tpl.php');
        }
        else{
			$main_content = new Templater(DIR_FIELDS_HTML.'password.tpl.php');
       }
		$main_content=$main_content->parse();
		$fields = array("%CLASS%","%NAME%","%ID%","%VALUE%","%EXTRA%","%LABEL%","%PLACEHOLDER%");
		$fields_replace = array($text['class'],$text['name'],$text['name'],$text['value'],$text['extraAtt'],$text['label'],$text['placeholder']);
	...
	public function textAreaEditor($text){
		...
		$main_content = new Templater(DIR_FIELDS_HTML.'textarea_editor.tpl.php');
		$main_content=$main_content->parse();
	...
	public function textArea($text){
       ...
       if($text["onlyField"]==true){
			$main_content = new Templater(DIR_FIELDS_HTML.'textarea_onlyfield.tpl.php');
        }
        else{
			$main_content = new Templater(DIR_FIELDS_HTML.'textarea.tpl.php');
        }
		$main_content=$main_content->parse();
		$fields = array("%CLASS%","%NAME%","%ID%","%VALUE%","%EXTRA%","%LABEL%");
	...
	public function checkBox($chk){
		...
		$main_content_only_field = new Templater(DIR_FIELDS_HTML.'checkbox_onlyfield.tpl.php');
		...
		if($chk['onlyField']==true){
		   return $sub_final_result;
			...
			$main_content = new Templater(DIR_FIELDS_HTML.'checkbox.tpl.php');
			$main_content=$main_content->parse();
	...
	public function radio($chk){
		...
		$main_content_only_field = new Templater(DIR_FIELDS_HTML.'radio_onlyfield.tpl.php');
		$main_content_only_field=$main_content_only_field->parse();
		...
		$fields = array("%LABEL_CLASS%","%CLASS%","%NAME%","%ID%","%VALUE%","%EXTRA%","%DISPLAY_VALUE%","%CHECKED%");
            ...
            if($chk['onlyField']==true){
				...
				$main_content = new Templater(DIR_FIELDS_HTML.'radio.tpl.php');
				$main_content=$main_content->parse();
	...
	function selectBox($field=array()){
		...
		$main_content_only_field = new Templater(DIR_FIELDS_HTML.'select_onlyfield.tpl.php');
		$main_content_only_field=$main_content_only_field->parse();
		...
		$main_content_options = new Templater(DIR_FIELDS_HTML.'select_options.tpl.php');
		...
		foreach($field['choices'] as $key => $value)
		{
			if($field['optgroup'])
			{
				$main_content_optiongroup = new Templater(DIR_FIELDS_HTML.'select_optiongroup.tpl.php');
		...
		if($field["onlyField"]==true){
			...
			$main_content = new Templater(DIR_FIELDS_HTML.'select.tpl.php');
			$main_content=$main_content->parse();
	...
	public function button($btn){
		...
		$main_content_only_field = new Templater(DIR_FIELDS_HTML.'button_onlyfield.tpl.php');
		$main_content_only_field=$main_content_only_field->parse();
		...
		if($btn['onlyField']==true){
			...
			$main_content = new Templater(DIR_FIELDS_HTML.'button.tpl.php');
			$main_content=$main_content->parse();
			$fields = array("%BUTTON%");
	...
	public function label($text){
        ...
        $text['extraAtt'] = isset($text['extraAtt']) ? $text['extraAtt'] : '';
		$main_content = new Templater(DIR_FIELDS_HTML.'label.tpl.php');
		$main_content=$main_content->parse();
	...
	public function link($text){
		...
		$main_content = new Templater(DIR_FIELDS_HTML.'link.tpl.php');
		$main_content=$main_content->parse();
	...
	public function img($text){
		...
		if($text['onlyField']==true){
		$main_content = new Templater(DIR_FIELDS_HTML.'img_onlyfield.tpl.php');
		$main_content=$main_content->parse();
		}else{
		$main_content = new Templater(DIR_FIELDS_HTML.'img.tpl.php');
		$main_content=$main_content->parse();
		}
		$fields = array("%LABEL%","%HREF%","%SRC%","%CLASS%","%ID%","%ALT%","%WIDTH%","%HEIGHT%","%EXTRA%");
		$fields_replace = array($text['label'],$text['href'],$text['src'],$text['class'],$text['id'],$text['name'],$text['width'],$text['height'],$text['extraAtt']);
		return str_replace($fields,$fields_replace,$main_content);

	}
	public function buttonpanel_start(){
		$main_content = new Templater(DIR_FIELDS_HTML.'buttonpanel_start.tpl.php');
		$main_content=$main_content->parse();

		return $main_content;
	}
	public function buttonpanel_end(){
		$main_content = new Templater(DIR_FIELDS_HTML.'buttonpanel_end.tpl.php');
		$main_content=$main_content->parse();
		return $main_content;
	}
	public function form_start($text){
		...
		$main_content = new Templater(DIR_FIELDS_HTML.'form_start.tpl.php');
		$main_content=$main_content->parse();
	...
	public function form_end(){
		$main_content = new Templater(DIR_FIELDS_HTML.'form_end.tpl.php');
		$main_content=$main_content->parse();
		return $main_content;
	}
	public function toggel_switch($text){
		...
		$main_content = new Templater(DIR_FIELDS_HTML.'switch.tpl.php');
		$main_content=$main_content->parse();
	...
	function rattingBox($field=array()){
		...
		$main_content_only_field = new Templater(DIR_FIELDS_HTML.'ratting_onlyfield.tpl.php');
		$main_content_only_field=$main_content_only_field->parse();
		...
		$main_content_options = new Templater(DIR_FIELDS_HTML.'ratting_select_options.tpl.php');
		$main_content_options=$main_content_options->parse();
		$content_fields = array("%VALUE%","%SELECTED%","%DISPLAY_VALUE%");
		...
		if($field["onlyField"]==true){
			...
			$main_content = new Templater(DIR_FIELDS_HTML.'ratting.tpl.php');
			$main_content=$main_content->parse();
			$content_fields = array("%LABEL%","%SELECT_BOX%");
			$content_fields_replace = array($field['label'],$final_result_only_field);
			$final_result = str_replace($content_fields,$content_fields_replace,$main_content);
	...
	public function dateRangeBox($text){
		...
		if($text["onlyField"]==true){
			$main_content = new Templater(DIR_FIELDS_HTML.'daterangebox_onlyfield.tpl.php');
        }
        else{
			$main_content = new Templater(DIR_FIELDS_HTML.'daterangebox.tpl.php');
       }
		$main_content=$main_content->parse();
	...
	public function captcha($text){
		$text['label'] = isset($text['label']) ? $text['label'] : 'Enter Text Here: ';
		$text['class'] = isset($text['class']) ? 'form-control '.trim($text['class']) : 'form-control';
        $text['extraAtt'] = isset($text['extraAtt']) ? $text['extraAtt'] : '';

		$main_content = new Templater(DIR_FIELDS_HTML.'captcha.tpl.php');
